                                ...
                                <div className="card">
                                    <div className="card-body text-center p-5">
                                        <div className="alert alert-warning mb-4">
                                            ...
                                            Child data not found. Please select a subcategory.
                                        </div>
                                        <button
            ...
            <div className="content">
                <div className="container-fluid">
                    <div className="py-3 d-flex align-items-center justify-content-between">
                        <div>
                            <h4 className="mb-0">Child Categogry Details</h4>
                    ...
                    <div className="card mt-3">
                        <div className="card-body">
                            <h5 className="card-title">
                                <i className="fas fa-info-circle me-2"></i>Child Category Information
                            </h5>
                            <div className="row mt-3">
                                <div className="col-md-12">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item px-0 py-2"><strong>Sub Category:</strong> {subCategoryData.subCategoryId?.name || "N/A"}</li>
