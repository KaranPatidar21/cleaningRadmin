        ...
        <div className="container-fluid">
          <div className="py-3 d-flex align-items-sm-center flex-sm-row flex-column justify-content-between">
            <div className="flex-grow-1">
              <h4 className="fs-18 fw-semibold m-0">Add New Vendor</h4>
            </div>
            <div>
              <button
                type="button"
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row">
                      ...
                      {aadharPreview && (
                        <div className="col-md-12">
                          <div className="mb-3">
                            <label className="form-label">Aadhar Card Preview</label>
                            <img
                              src={aadharPreview}
                      ...
                      {panPreview && (
                        <div className="col-md-12">
                          <div className="mb-3">
                            <label className="form-label">PAN Card Preview</label>
                            <img
                              src={panPreview}
...
export default AddVenderManagement;